...
Full Stack Developer building scalable products with strong frontend
ownership and solid backend fundamentals.
...
architecture\
🌍 Maintaining open source projects under LearnGrowCode
...
-   Leading frontend development from foundation to production using
    Next.js 16 and Material UI\
-   Handling API integration, authentication flows, and scalable
    architecture decisions\
-   Working closely with backend engineers and management on system
    design\
-   Implemented permission gateway for B2B authentication at frontend
    level\
-   Managing SSR performance and scalable component systems
...
I have built and deployed two production ready Expo applications, both
maintained as open source projects.

### 💧 Water Timeout

Hydration reminder app focused on habit formation and emotional
motivation.
...
Play Store\
https://play.google.com/store/apps/details?id=app.web.money_on_track_1.twa

Open Source\
https://github.com/LearnGrowCode/MOT_Frontend
...
**Frontend**\
Next.js, React, Material UI, Tailwind, TanStack Query

**Backend**\
Django, Django REST Framework, Node.js, Express

**Architecture**\
SSR optimization, scalable component systems, API integration,
...
I focus on clean architecture, maintainable systems, and real world
scalability.\
I aim to become a top tier engineer by continuously improving depth in
frontend systems and backend design.
